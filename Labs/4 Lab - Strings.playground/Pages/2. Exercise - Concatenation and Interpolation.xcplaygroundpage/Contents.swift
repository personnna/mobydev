 ...
 */
/*:
Объявите константу `name` и назначьте ей свое имя в виде строкового литерала. Затем объявите константу `age` и задайте ей текущий возраст как `Int`. Затем выведите следующую фразу, используя интерполяцию строк:

- «Меня зовут <ВСТАВЬТЕ ИМЯ>, и после моего следующего дня рождения мне будет <ВСТАВИТЬ ВОЗРАСТ> лет».
