 ...
 */
/*:
В вашем приложении вы можете искать других пользователей. Было бы проще, если бы имена и фамилии хранились отдельно. Это не редкая практика.
 ...
 */
/*:
Иногда пользователи вашего приложения для отслеживания физической формы могут побить предыдущие цели или рекорды. Вы можете уведомить их, когда это произойдет, в целях поощрения. Создайте новую константу `congratulations` и назначьте ей строковый литерал, который использует интерполяцию строк для создания следующей строки:
 
- "Поздравляем, <ВСТАВЬТЕ ЗДЕСЬ ПОЛНОЕ ИМЯ ПОЛЬЗОВАТЕЛЯ>! Вы превзошли свой предыдущий дневной рекорд в <ВСТАВЬТЕ ПРЕДЫДУЩИЕ САМЫЕ ВЫСОКИЕ ШАГИ ЗДЕСЬ>, пройдя вчера <ВСТАВЬТЕ НОВЫЕ САМЫЕ ВЫСОКИЕ ШАГИ> шагов!"
